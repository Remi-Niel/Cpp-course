// Generated by Bisonc++ V6.01.00 on Sun, 17 Mar 2019 14:15:36 +0100
...
PI__ const s_productionInfo[] = 
{
     ...
     {258, 2}, // 1: expressions ->  expressions expression
     {258, 0}, // 2: expressions ->  <empty>
     {259, 3}, // 3: expression ('(') ->  '(' expression ')'
     {259, 1}, // 4: expression ->  addition
     {259, 1}, // 5: expression ->  subtraction
     {259, 1}, // 6: expression ->  multiplication
     {259, 1}, // 7: expression ->  division
     {259, 1}, // 8: expression ->  squared
     {259, 1}, // 9: expression ->  negation
     {259, 1}, // 10: expression (NUMBER) ->  NUMBER
     {260, 3}, // 11: addition ('+') ->  expression '+' expression
     {261, 3}, // 12: subtraction ('-') ->  expression '-' expression
     {262, 3}, // 13: multiplication ('*') ->  expression '*' expression
     {263, 3}, // 14: division ('/') ->  expression '/' expression
     {264, 2}, // 15: squared ('$') ->  '$' expression
     {265, 2}, // 16: negation ('-') ->  '-' expression
     {266, 1}, // 17: expressions_$ ->  expressions
};
