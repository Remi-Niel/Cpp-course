// Generated by Bisonc++ V6.01.03 on Wed, 27 Mar 2019 14:38:33 +0100
...
PI__ const s_productionInfo[] = 
{
     ...
     {261, 1}, // 1: ruleset ->  rule
     {261, 2}, // 2: ruleset ->  ruleset rule
     {262, 4}, // 3: rule (':') ->  literal ':' rulebody ';'
     {263, 1}, // 4: rulebody ->  line
     {263, 3}, // 5: rulebody ('|') ->  rulebody '|' line
     {264, 1}, // 6: line ->  literal
     {264, 2}, // 7: line ->  line literal
     {265, 1}, // 8: literal (IDENT) ->  IDENT
     {266, 1}, // 9: ruleset_$ ->  ruleset
};
...
#line 28 "grammar"
        {
         print_rule(vs__(-3).get<Tag__::IDENT>(), vs__(-1).get<Tag__::IDENT>());
         }
        break;
...
#line 40 "grammar"
        {
         d_val__ = append(vs__(-2).get<Tag__::IDENT>(), append(" @ ", vs__(0).get<Tag__::IDENT>()));
         }
        break;
...
#line 52 "grammar"
        {
         d_val__ = append(vs__(-1).get<Tag__::IDENT>(), vs__(0).get<Tag__::IDENT>());
         }
        break;
