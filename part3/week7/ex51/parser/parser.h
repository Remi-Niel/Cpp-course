...
class Parser: public ParserBase
{
    ...
    // added functions for the calculator:
        ...
        RuleValue &bNOT(RuleValue &e);
        RuleValue &bAND(RuleValue &lvalue, RuleValue &rvalue);
        RuleValue &bOR(RuleValue &lvalue, RuleValue &rvalue);
        RuleValue &bXOR(RuleValue &lvalue, RuleValue &rvalue);
