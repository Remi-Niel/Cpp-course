// Generated by Bisonc++ V6.01.00 on Sat, 23 Mar 2019 14:11:10 +0100
...
#line 151 "grammar"
        {
         RuleValue tmp{vs__(-2)};
         d_val__ = assign(vs__(-2), mul(tmp, vs__(0)));
         }
        break;
...
#line 157 "grammar"
        {
         RuleValue tmp{vs__(-2)};
         d_val__ = assign(vs__(-2), div(tmp, vs__(0)));
         }
        break;
...
#line 163 "grammar"
        {
         RuleValue tmp{vs__(-2)};
         d_val__ = assign(vs__(-2), mod(tmp, vs__(0)));
         }
        break;
...
#line 169 "grammar"
        {
         RuleValue tmp{vs__(-2)};
         d_val__ = assign(vs__(-2), add(tmp, vs__(0)));
         }
        break;
...
#line 175 "grammar"
        {
         RuleValue tmp{vs__(-2)};
         d_val__ = assign(vs__(-2), sub(tmp, vs__(0)));
         }
        break;
...
#line 181 "grammar"
        {
         RuleValue tmp{vs__(-2)};
         d_val__ = assign(vs__(-2), lshift(tmp, vs__(0)));
         }
        break;
...
#line 187 "grammar"
        {
         RuleValue tmp{vs__(-2)};
         d_val__ = assign(vs__(-2), rshift(tmp, vs__(0)));
         }
        break;
...
#line 193 "grammar"
        {
         RuleValue tmp{vs__(-2)};
         d_val__ = assign(vs__(-2), bAND(tmp, vs__(0)));
         }
        break;
...
#line 199 "grammar"
        {
         RuleValue tmp{vs__(-2)};
         d_val__ = assign(vs__(-2), bOR(tmp, vs__(0)));
         }
        break;
...
#line 205 "grammar"
        {
         RuleValue tmp{vs__(-2)};
         d_val__ = assign(vs__(-2), bXOR(tmp, vs__(0)));
         }
        break;
